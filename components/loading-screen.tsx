  ...
  return (
    <div className={`fixed inset-0 z-9999 flex items-center justify-center transition-all duration-500 ease-out ${
      ...
      <div className={`absolute inset-0 transition-all duration-700 ${
        isDark 
            ? 'bg-linear-to-br from-purple-900/5 via-transparent to-purple-800/5' 
            : 'bg-linear-to-br from-purple-100/50 via-transparent to-purple-50/50'
      }`} />
      ...
      <div className={`absolute inset-0 opacity-10 transition-all duration-200 ${
        ...
        <div className="absolute inset-0 bg-linear-to-br from-transparent via-current to-transparent" />
      </div>
    </div>
  );
}
