  ...
  return (
    <div className="space-y-4">
      ...
      <div className="space-y-2">
        ...
        <div className={`p-4 bg-muted material-radius transition-all duration-200 theme-transition ${
          hapticsAvailable ? "opacity-100" : "opacity-50"
        }`}>
          <div className="mb-2">
            <span className="font-medium">Haptic Profile</span>
            <p className="text-sm text-muted-foreground">
              Tune tactile feel: subtle, balanced, or punchy.
            </p>
          </div>
