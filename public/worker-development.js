...
/* harmony export */ });
/* harmony import */ var D_My_Files_Projects_tgatb_habit_tracker_node_modules_next_dist_compiled_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(73);
...
function _objectSpread(e) { for (var r = 1; r < arguments.length; r++) { var t = null != arguments[r] ? arguments[r] : {}; r % 2 ? ownKeys(Object(t), !0).forEach(function (r) { (0,D_My_Files_Projects_tgatb_habit_tracker_node_modules_next_dist_compiled_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_0__["default"])(e, r, t[r]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t)) : ownKeys(Object(t)).forEach(function (r) { Object.defineProperty(e, r, Object.getOwnPropertyDescriptor(t, r)); }); } return e; }
...
// Google Fonts
(0,workbox_routing__WEBPACK_IMPORTED_MODULE_1__.registerRoute)(/^https:\/\/fonts\.googleapis\.com\/.*/i, new workbox_strategies__WEBPACK_IMPORTED_MODULE_2__.CacheFirst({
...
(0,workbox_routing__WEBPACK_IMPORTED_MODULE_1__.registerRoute)(/^https:\/\/fonts\.gstatic\.com\/.*/i, new workbox_strategies__WEBPACK_IMPORTED_MODULE_2__.CacheFirst({
...
// Static Assets
(0,workbox_routing__WEBPACK_IMPORTED_MODULE_1__.registerRoute)(/\.(?:jpg|jpeg|gif|png|svg|ico|webp)$/i, new workbox_strategies__WEBPACK_IMPORTED_MODULE_2__.StaleWhileRevalidate({
...
(0,workbox_routing__WEBPACK_IMPORTED_MODULE_1__.registerRoute)(({
  request
}) => request.destination === 'document', new workbox_strategies__WEBPACK_IMPORTED_MODULE_2__.NetworkFirst({
  cacheName: 'pages',
  plugins: [new workbox_expiration__WEBPACK_IMPORTED_MODULE_3__.ExpirationPlugin({
    maxEntries: 10,
    maxAgeSeconds: 24 * 60 * 60 // 24 hours
...
self.addEventListener('push', event => {
  if (event.data) {
    ...
    event.waitUntil(self.registration.showNotification('TGATB Habit Tracker', options));
  }
});
self.addEventListener('notificationclick', event => {
  ...
  if (event.action === 'open' || !event.action) {
    ...
    event.waitUntil(self.clients.openWindow(((_event$notification$d = event.notification.data) === null || _event$notification$d === void 0 ? void 0 : _event$notification$d.url) || '/'));
  }
});
